...
export function createNewNode(
	...
	else if (component.name === 'DbTableInfo')
		createDbTableInfo(newWfNode)
...
function createHttpRequest(node: Workflow.WorkflowNode) {
	node.nodeConfig = {
		...
		headers: [{name: 'Accept', value: '*/*'}, {name: 'Cache-Control', value: 'no-cache'}, {
			name: 'Connection',
			value: 'keep-alive'
		}],
		params: [],
...
function createDbTableInfo(node: Workflow.WorkflowNode) {
	node.nodeConfig = {
		dburl: '',
		dbuser: '',
		dbpassword: '',
